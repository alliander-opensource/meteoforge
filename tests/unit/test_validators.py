...
def test_validate_mf_location_valid():
...
def test_validate_mf_location_invalid_type():
...
def test_validate_location_out_of_bounds():
...
def test_validate_mf_period_stub():
